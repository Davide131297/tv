  ...
  return (
    <div className="container mx-auto py-12 px-4 max-w-4xl">
      ...
      <div className="space-y-12">
        <section>
          <div className="bg-slate-50 dark:bg-slate-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-800 mb-4">
            <span className="font-mono bg-slate-200 dark:bg-slate-800 px-2 py-1 rounded text-sm mr-2">
              BASIS-URL
            </span>
        ...
        <section id="party-timeline">
          ...
          <div className="flex items-center gap-2 mb-4">
            <span className="bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-400 text-xs font-bold px-2 py-1 rounded">
              GET
            </span>
            <code className="bg-slate-100 dark:bg-slate-800/80 px-2 py-1 rounded">
              /party-timeline
            </code>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left mb-4">
              <thead className="bg-slate-50 dark:bg-slate-900/50 border-b border-gray-200 dark:border-gray-800">
                <tr>
              ...
              <tbody>
                <tr className="border-b border-gray-200 dark:border-gray-800">
                  ...
                  <td className="py-2 px-3 text-gray-500 dark:text-gray-400">Nein</td>
            ...
            <table className="w-full text-sm text-left mb-4">
              ...
              <tbody>
                <tr className="border-b border-gray-200 dark:border-gray-800">
                  ...
                  <td className="py-2 px-3">string</td>
                  <td className="py-2 px-3 font-semibold text-red-600 dark:text-red-400">Ja</td>
        ...
        <section id="politics">
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <code className="bg-slate-100 dark:bg-slate-800/80 px-2 py-1 rounded">/politics</code>
          </div>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
